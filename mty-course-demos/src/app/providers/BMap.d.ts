...
declare namespace BMap {
    ...
    class Map {
        ...
        /**鼠标双击地图时触发此事件。 */
        dblclick: (event?: { type: any, target: any, point: any, pixel: any, overlay: any }) => void;
        /**右键单击地图时触发此事件。。 当双击时，产生的事件序列为： click click dblclick */
        rightclick: (event?: { type: any, target: any, point: any, pixel: any, overlay: any }) => void;
        /**右键双击地图时触发此事件。 */
        rightdblclick: (event?: { type: any, target: any, point: any, pixel: any, overlay: any }) => void;
        /**地图类型发生变化时触发此事件。 */
        maptypechange: (event?: { type: any, target: any }) => void;
        /**鼠标在地图区域移动过程中触发此事件。 */
        mousemove: (event?: { type: any, target: any, point: any, pixel: any, overlay: any }) => void;
        /**鼠标移入地图区域时触发此事件。 */
        mouseover: (event?: { type: any, target: any }) => void;
        /**鼠标移出地图区域时触发此事件。 */
        mouseout: (event?: { type: any, target: any }) => void;
        /**地图移动开始时触发此事件。 */
        movestart: (event?: { type: any, target: any }) => void;
        /**地图移动过程中触发此事件。 */
        moving: (event?: { type: any, target: any }) => void;
        /**地图移动结束时触发此事件。 */
        moveend: (event?: { type: any, target: any }) => void;
        /**地图更改缩放级别开始时触发触发此事件。 */
        zoomstart: (event?: { type: any, target: any }) => void;
        /**地图更改缩放级别结束时触发触发此事件。 */
        zoomend: (event?: { type: any, target: any }) => void;
        /**当使用Map.addControl()方法向地图中添加单个控件时会触发此事件。 */
        addcontrol: (event?: { type: any, target: any }) => void;
        /**当使用Map.removeControl()方法移除单个控件时会触发此事件。 */
        removecontrol: (event?: { type: any, target: any }) => void;
        ...
        removeoverlay: (event?: { type: any, target: any }) => void;
        /**当使用Map.clearOverlays()方法一次性移除全部覆盖物时会触发此事件。 */
        clearoverlays: (event?: { type: any, target: any }) => void;
        /**开始拖拽地图时触发 */
        dragstart: (event?: { type: any, target: any, pixel: any, point: any }) => void;
        /**拖拽地图过程中触发 */
        dragging: (event?: { type: any, target: any, pixel: any, point: any }) => void;
        /**停止拖拽地图时触发 */
        dragend: (event?: { type: any, target: any, pixel: any, point: any }) => void;
        /**添加一个自定义地图图层时触发此事件。 */
        addtilelayer: (event: { type: any, target: any }) => void;
        /**移除一个自定义地图图层时触发此事件。 */
        removetilelayer: (event?: { type: any, target: any }) => void;
        /**调用Map.centerAndZoom()方法时会触发此事件。这表示位置、缩放层级已经确定，但可能还在载入地图图块 */
        load: (event?: { type: any, target: any, pixel: any, point: any, zoom: any }) => void;
        /**地图可视区域大小发生变化时会触发此事件 */
        resize: (event?: { type: any, target: any, size: any }) => void;
        /**点击热区时触发此事件 */
        hotspotclick: (event?: { type: any, target: any, spots: any }) => void;
        /**鼠标移至热区时触发此事件 */
        hotspotover: (event?: { type: any, target: any, spots: any }) => void;
        /**鼠标移出热区时触发此事件 */
        hotspotout: (event?: { type: any, target: any, spots: any }) => void;
        /**当地图所有图块完成加载时触发此事件 */
        tilesloaded: (event?: { type: any, target: any }) => void;
        /**触摸开始时触发此事件，仅适用移动设备 */
        touchstart: (event?: { type: any, target: any, point: any, pixel: any }) => void;
        /**触摸移动时触发此事件，仅适用移动设备 */
        touchmove: (event?: { type: any, target: any, point: any, pixel: any }) => void;
        /**触摸结束时触发此事件，仅适用移动设备 */
        touchend: (event?: { type: any, target: any, point: any, pixel: any }) => void;
        /**长按事件，仅适用移动设备 */
        longpress: (event?: { type: any, target: any, point: any, pixel: any }) => void;
    }
    ...
    class GeolocationControl extends Control {
        ...
        /**定位成功后触发此事件 */
        locationSuccess: (point: any, arg1: AddressComponent) => void;
        locationError: (StatusCode: any) => void;
    }
    ...
    class OverviewMapControl extends Control {
        ...
        /**缩略地图开合状态发生变化后触发此事件 */
        viewchanged: (type: any, target: any, isOpen: any) => void;
        /** 缩略地图开合状态发生变化过程中触发此事件 */
        viewchanging: (type: any, target: any) => void;
    }
    ...
    class Marker extends Overlay {
        ...
        // 事件	参数	描述
        /**点击标注图标后会触发此事件 */
        click: (event: { type: any, target: any }) => void;
        /**双击标注图标后会触发此事件 */
        dblclick: (event: { type: any, target: any, point: any, pixel: any }) => void;
        /**鼠标在标注图上按下触发此事件 */
        mousedown: (event: { type: any, target: any, point: any, pixel: any }) => void;
        /**鼠标在标注图上释放触发此事件 */
        mouseup: (event: { type: any, target: any, point: any, pixel: any }) => void;
        /**鼠标离开标注时触发此事件 */
        mouseout: (event: { type: any, target: any, point: any, pixel: any }) => void;
        /**当鼠标进入标注图标区域时会触发此事件 */
        mouseover: (event: { type: any, target: any, point: any, pixel: any }) => void;
        /**移除标注时触发 */
        remove: (event: { type: any, target: any }) => void;
        /**信息窗在此标注上关闭时触发此事件 */
        infowindowclose: (event: { type: any, target: any }) => void;
        /**信息窗在此标注上打开时触发此事件 */
        infowindowopen: (event: { type: any, target: any }) => void;
        /**开始拖拽标注时触发此事件 */
        dragstart: (event: { type: any,  target:any}) => void;
        /**拖拽标注过程中触发此事件 */
        dragging: (event: { type: any, target: any, pixel: any, point: any }) => void;
        /**拖拽结束时触发此事件 */
        dragend: (event: { type: any, target: any, pixel: any, point: any }) => void;
        /**右键点击标注时触发此事件 */
        rightclick: (event: { type: any, target: any }) => void;
    }
    ...
    class InfoWindow extends Overlay {
        ...
        /**信息窗口被关闭时触发此事件 */
        close: (event: { type: any, target: any, point: any }) => void;
        /**信息窗口被打开时触发此事件 */
        open: (event: { type: any, target: any, point: any }) => void;
        /**信息窗口最大化后触发此事件 */
        maximize(event: { type: any, target: any }): void;
        /**信息窗口还原时触发此事件 */
        restore(event: { type: any, target: any }): void;
        /**点击信息窗口的关闭按钮时触发此事件 */
        clickclose: (event: { type: any, target: any }) => void;
    }
    ...
    class Label extends Overlay {
        ...
        click: (event: { type: any, target: any }) => void;
        /**双击文本标注后会触发此事件 */
        dblclick: (event: { type: any, target: any }) => void;
        /**鼠标在文本标注上按下触发此事件 */
        mousedown: (event: { type: any, target: any }) => void;
        /**鼠标在文本标注释放触发此事件 */
        mouseup: (event: { type: any, target: any }) => void;
        /**鼠标离开文本标注时触发此事件 */
        mouseout: (event: { type: any, target: any }) => void;
        /**当鼠标进入文本标注区域时会触发此事件 */
        mouseover: (event: { type: any, target: any }) => void;
    ...
    class Polyline extends Overlay {
        ...
        /**点击折线后会触发此事件 */
        click: (event: { type: any, target: any, point: any, pixel: any }) => void;
        /**双击折线后会触发此事件 */
        dblclick: (event: { type: any, target: any, point: any, pixel: any }) => void;
        /**鼠标在折线上按下触发此事件 */
        mousedown: (event: { type: any, target: any, point: any, pixel: any }) => void;
        ...
        remove: (event: { type: any, target: any }) => void;
        /**覆盖物的属性发生变化时触发 */
        lineupdate: (event: { type: any, target: any }) => void;
    }
    ...
    class PointCollection extends Overlay {
        ...
        /**鼠标点击点时会触发此事件 */
        click: (event: { type: any, target: any, point: any }) => void;
        /**鼠标移入点时会触发该事件 */
        mouseover: (event: { type: any, target: any, point: any }) => void;
        /**鼠标移出点时会触发该事件 */
        mouseout: (event: { type: any, target: any, point: any }) => void;
    }
    ...
    class ContextMenu {
        ...
        open: (event: { type: any, target: any, point: any, pixel: any }) => void;
        /**右键菜单关闭时触发，事件参数point和pixel分别表示菜单开启时的地理和像素坐标点 */
        close: (event: { type: any, target: any, point: any, pixel: any }) => void;
    }
    ...
    class CustomLayer {
        ...
        hotspotclick: (event: { type: any, target: any, content: any }) => void;
    }
    ...
    class Autocomplete {
         ...
         */
        onconfirm: (event: { type: any, target: any, item: any }) => void;
        /**
         * 键盘或者鼠标移动，某条记录高亮之后，
         * 触发 fromitem: {
         *  【上一条记录的信息】
         ...
         */
        onhighlight: (event: { type: any, target: any, fromitem: any, toitem: any }) => void;
    }
    ...
    class PanoramaLabel {
        ...
        /** 单击标签时触发该事件 */
        click: (type: any, target: any) => void;
        /** 鼠标移入标签时触发该事件 */
        mouseover: (type: any, target: any) => void;
        /** 鼠标移出标签时触发该事件 */
        mouseout: (type: any, target: any) => void;
        /** 删除标签时触发该事件 */
        remove: (type: any, target: any) => void;
    }
...
/** 默认 */
declare const BMAP_DRIVING_POLICY_DEFAULT: any;
/** 高速优先 */
declare const BMAP_DRIVING_POLICY_FIRST_HIGHWAYS: any;
/** 避开高速 */
declare const BMAP_DRIVING_POLICY_AVOID_HIGHWAYS: any;
/** 避开拥堵 */
declare const BMAP_DRIVING_POLICY_AVOID_CONGESTION: any;
...
/**【lengthUnit】公制单位 */
declare const BMAP_UNIT_METRIC: any;
/**【lengthUnit】英制单位 */
declare const BMAP_UNIT_IMPERIAL: any;


/**按钮水平方式展示，默认采用此类型展示 */
declare const BMAP_MAPTYPE_CONTROL_HORIZONTAL: any;
/**按钮呈下拉列表方式展示 */
declare const BMAP_MAPTYPE_CONTROL_DROPDOWN: any;
/**以图片方式展示类型控件，设置该类型后无法指定maptypes属性 */
declare const BMAP_MAPTYPE_CONTROL_MAP: any;
...
/**圆形，默认半径为1px */
declare const BMap_Symbol_SHAPE_CIRCLE: any;
/**矩形，默认宽度4px、高度2px */
declare const BMap_Symbol_SHAPE_RECTANGLE: any;
/**菱形，默认外接圆半径10px */
declare const BMap_Symbol_SHAPE_RHOMBUS: any;
/**五角星，五角星外接圆半径为10px */
declare const BMap_Symbol_SHAPE_STAR: any;
/**箭头方向向下的闭合箭头 */
declare const BMap_Symbol_SHAPE_BACKWARD_CLOSED_ARROW: any;
/**箭头方向向上的闭合箭头 */
declare const BMap_Symbol_SHAPE_FORWARD_CLOSED_ARROW: any;
/**箭头方向向下的非闭合箭头 */
declare const BMap_Symbol_SHAPE_BACKWARD_OPEN_ARROW: any;
/**箭头方向向上的非闭合箭头 */
declare const BMap_Symbol_SHAPE_FORWARD_OPEN_ARROW: any;
/**定位点图标 */
declare const BMap_Symbol_SHAPE_POINT: any;
/**预设的飞机形状 */
declare const BMap_Symbol_SHAPE_PLANE: any;
/**预设的照相机形状 */
declare const BMap_Symbol_SHAPE_CAMERA: any;
/**预设的警告符号 */
declare const BMap_Symbol_SHAPE_WARNING: any;
/**预设的笑脸形状 */
declare const BMap_Symbol_SHAPE_SMILE: any;
/**预设的钟表形状 */
declare const BMap_Symbol_SHAPE_CLOCK: any;


/** 驾车线路 */
declare const BMAP_ROUTE_TYPE_DRIVING: any;
/** 步行线路 */
declare const BMAP_ROUTE_TYPE_WALKING: any;
/** 骑行线路 */
declare const BMAP_ROUTE_TYPE_RIDING: any;


/**麻点密度高 */
declare const BMAP_POINT_DENSITY_HIGH: any;
/**麻点密度中等，默认 */
declare const BMAP_POINT_DENSITY_MEDIUM: any;
/**麻点密度低 */
declare const BMAP_POINT_DENSITY_LOW: any;

/** 检索成功。对应数值“0” */
declare const BMAP_STATUS_SUCCESS: any;
/** 城市列表。对应数值“1” */
declare const BMAP_STATUS_CITY_LIST: any;
/** 位置结果未知。对应数值“2” */
declare const BMAP_STATUS_UNKNOWN_LOCATION: any;
/** 导航结果未知。对应数值“3” */
declare const BMAP_STATUS_UNKNOWN_ROUTE: any;
/** 非法密钥。对应数值“4” */
declare const BMAP_STATUS_INVALID_KEY: any;
/** 非法请求。对应数值“5” */
declare const BMAP_STATUS_INVALID_REQUEST: any;
/** 没有权限。对应数值“6” */
declare const BMAP_STATUS_PERMISSION_DENIED: any;
/** 服务不可用。对应数值“7” */
declare const BMAP_STATUS_SERVICE_UNAVAILABLE: any;
/** 超时。对应数值“8” */
declare const BMAP_STATUS_TIMEOUT: any;

/** 全景场景点的类型为室内场景 */
declare const BMAP_PANORAMA_INDOOR_SCENE: any;
/** 全景场景点的类型为室外场景 */
declare const BMAP_PANORAMA_STREET_SCENE: any;

/** 酒店类 */
declare const BMAP_PANORAMA_POI_HOTEL: any;
/** 餐饮类 */
declare const BMAP_PANORAMA_POI_CATERING: any;
/** 电影院 */
declare const BMAP_PANORAMA_POI_MOVIE: any;
/** 公交站点 */
declare const BMAP_PANORAMA_POI_TRANSIT: any;
/** 室内景 */
declare const BMAP_PANORAMA_POI_INDOOR_SCENE: any;
/** 无，即隐藏所有的poi类型 */
declare const BMAP_PANORAMA_POI_NONE: any;

/**圆形，为默认形状 */
declare const BMAP_POINT_SHAPE_CIRCLE: any;
/**星形 */
declare const BMAP_POINT_SHAPE_STAR: any;
/**方形 */
declare const BMAP_POINT_SHAPE_SQUARE: any;
/**菱形 */
declare const BMAP_POINT_SHAPE_RHOMBUS: any;
/**水滴状，该类型无size和color属性 */
declare const BMAP_POINT_SHAPE_WATERDROP: any;


/**定义点的尺寸为超小，宽高为2px * 2px */
declare const BMAP_POINT_SIZE_TINY: any;
/**定义点的尺寸为很小，宽高为4px * 4px */
declare const BMAP_POINT_SIZE_SMALLER: any;
/**定义点的尺寸为小，宽高为8px * 8px */
declare const BMAP_POINT_SIZE_SMALL: any;
/**定义点的尺寸为正常，宽高为10px * 10px，为海量点默认尺寸 */
declare const BMAP_POINT_SIZE_NORMAL: any;
/**定义点的尺寸为大，宽高为16px * 16px */
declare const BMAP_POINT_SIZE_BIG: any;
/**定义点的尺寸为很大，宽高为20px * 20px */
declare const BMAP_POINT_SIZE_BIGGER: any;
/**定义点的尺寸为超大，宽高为30px * 30px */
declare const BMAP_POINT_SIZE_HUGE: any;

/**放大图标 */
declare const BMAP_CONTEXT_MENU_ICON_ZOOMIN: any;
/**缩小图标 */
declare const BMAP_CONTEXT_MENU_ICON_ZOOMOUT: any;

/**一般位置点 */
declare const BMAP_POI_TYPE_NORMAL: any;
/**公交车站位置点 */
declare const BMAP_POI_TYPE_BUSSTOP: any;
/**地铁车站位置点 */
declare const BMAP_POI_TYPE_SUBSTOP: any;

/**推荐方案 */
declare const BMAP_TRANSIT_POLICY_RECOMMEND: any;
/**最少时间 */
declare const BMAP_TRANSIT_POLICY_LEAST_TIME: any;
/**最少换乘 */
declare const BMAP_TRANSIT_POLICY_LEAST_TRANSFER: any;
/**最少步行 */
declare const BMAP_TRANSIT_POLICY_LEAST_WALKING: any;
/**不乘地铁 */
declare const BMAP_TRANSIT_POLICY_AVOID_SUBWAYS: any;
/**优先地铁 */
declare const BMAP_TRANSIT_POLICY_FIRST_SUBWAYS: any;

/**时间短 */
declare const BMAP_INTERCITY_POLICY_LEAST_TIME: any;
/**出发早 */
declare const BMAP_INTERCITY_POLICY_EARLY_START: any;
/**价格低 */
declare const BMAP_INTERCITY_POLICY_CHEAP_PRICE: any;

/**火车优先 */
declare const BMAP_TRANSIT_TYPE_POLICY_TRAIN: any;
/**飞机优先 */
declare const BMAP_TRANSIT_TYPE_POLICY_AIRPLANE: any;
/**大巴优先 */
declare const BMAP_TRANSIT_TYPE_POLICY_COACH: any;

/**国内市内换乘 */
declare const BMAP_TRANSIT_TYPE_IN_CITY: any;
/**国内跨城换乘 */
declare const BMAP_TRANSIT_TYPE_CROSS_CITY: any;


/**公交车 */
declare const BMAP_LINE_TYPE_BUS: any;
/**地铁 */
declare const BMAP_LINE_TYPE_SUBWAY: any;
/**轮渡 */
declare const BMAP_LINE_TYPE_FERRY: any;
/**火车 */
declare const BMAP_LINE_TYPE_TRAIN: any;
/**飞机 */
declare const BMAP_LINE_TYPE_AIRPLANE: any;
/**大巴 */
declare const BMAP_LINE_TYPE_COACH: any;

/** 驾车结果展现中点击列表后的展现点步骤 */
declare const BMAP_HIGHLIGHT_STEP: any;
/** 驾车结果展现中点击列表后的展现路段 */
declare const BMAP_HIGHLIGHT_ROUTE: any;
